...
#Sprites, Pixies, and Fairies:
#Sprites are the simplest and fastest form of image object, you give them the dimensions on load and they stay static, with no animations. Best for backgrounds,menus.
#Pixies are a sheet of sprites, that only act when acted upon, good for player characters and world objects, can animate
#Fairies are sprites with an NPC package, they can transform and act autonomously, must be heavily initialized at first
